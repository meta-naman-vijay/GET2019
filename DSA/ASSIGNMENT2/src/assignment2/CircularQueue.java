 ...
 * @author naman
 * @param <T>
 *            queue store generic data type CircularQueue class creates a
...
public class CircularQueue<T> implements Queue<T> {
    ...
    /**
     * @param size
     *            is the max size of the Circular queue Constructor assign the
    ...
    /**
     * @param element
     *            insert method inserts the element to the queue if the queue is
